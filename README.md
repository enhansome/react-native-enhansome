...
[![](https://jaywcjlove.github.io/sb/ico/awesome.svg)](#目录) [![](https://jaywcjlove.github.io/sb/lang/chinese.svg)](https://github.com/crazycodeboy/react-native-awesome) ⭐ 1,816 | 🐛 8 | 📅 2019-12-06 [![](https://jaywcjlove.github.io/sb/lang/english.svg)](https://github.com/jondot/awesome-react-native) ⭐ 35,699 | 🐛 20 | 📅 2026-08-26
...
* [React Native官方Demo](https://github.com/facebook/react-native/tree/master/Examples) ⭐ 126,589 | 🐛 1,161 | 🌐 C++ | 📅 2026-09-14：React Native官方Demo，汇集了各种组件，API的使用Examples。
...
* [HackerNews-React-Native](https://github.com/iSimar/HackerNews-React-Native) ⭐ 3,705 | 🐛 12 | 🌐 JavaScript | 📅 2022-03-17：Hacker 新闻客户端。
...
* [react-native-nba-app](https://github.com/wwayne/react-native-nba-app) ⭐ 2,210 | 🐛 8 | 🌐 Objective-C | 📅 2019-10-20：This is why we play。
...
* [react-native-gitfeed](https://github.com/xiekw2010/react-native-gitfeed) ⭐ 1,701 | 🐛 8 | 🌐 JavaScript | 📅 2017-04-13：一款基于React Native的GitHub客户端。
...
* [react-native-vector-icons ★2281](https://github.com/oblador/react-native-vector-icons) ⭐ 17,914 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-07：用于 React Native的可定制的图标资源库，支持 NavBar/TabBar, image source 以及样式。
...
* [react-native-tab-navigator](https://github.com/exponentjs/react-native-tab-navigator) ⭐ 2,381 | 🐛 19 | 🌐 JavaScript | 📅 2020-09-30：一款兼容Android、iOS的TabBar组件。
...
* [react-native-swiper](https://github.com/leecade/react-native-swiper) ⭐ 10,477 | 🐛 780 | 🌐 JavaScript | 📅 2026-02-01：一款轮番滑动的组件。
...
* [react-native-htmlview](https://github.com/jsdf/react-native-htmlview) ⭐ 2,746 | 🐛 144 | 🌐 JavaScript | 📅 2024-06-11：HTML显示组件，渲染HTML text 。
...
* [react-native-popover](https://github.com/jeanregisser/react-native-popover) ⭐ 669 | 🐛 26 | 🌐 JavaScript | 📅 2019-04-23：一款类似Android popupwindow的弹出框组件。
...
* [NativeBase](https://github.com/GeekyAnts/NativeBase) ⭐ 20,374 | 🐛 376 | 🌐 TypeScript | 📅 2026-01-31：一款融合了ES6用于在React Native上创建创建高质量的Android\&iOS APP的框架。
...
* [Redux](https://github.com/reactjs/redux/) ⭐ 61,486 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-08：用于JavaScript apps上的一款可预见的状态管理框架。
...
* [react-native-web](https://github.com/necolas/react-native-web) ⭐ 22,135 | 🐛 167 | 🌐 JavaScript | 📅 2025-10-16：使用React Native组建Web应用。
