...
[![](https://jaywcjlove.github.io/sb/ico/awesome.svg)](#目录) [![](https://jaywcjlove.github.io/sb/lang/chinese.svg)](https://github.com/crazycodeboy/react-native-awesome) ⭐ 1,817 | 🐛 8 | 📅 2019-12-06 [![](https://jaywcjlove.github.io/sb/lang/english.svg)](https://github.com/jondot/awesome-react-native) ⭐ 35,699 | 🐛 145 | 🌐 JavaScript | 📅 2024-07-05

React Native Awesome 汇集了各类react-native学习资料、工具、组件、开源App、资源下载、以及相关新闻等，只求精不求全。

> 如果你是一名React Native爱好者，或者有一颗热爱钻研新技术的心，喜欢分享技术干货、项目经验、以及你在React Naive学习研究或实践中的一些经验心得等等，欢迎投稿[《React Native Awesome》](https://github.com/crazycodeboy/react-native-awesome) ⭐ 1,817 | 🐛 8 | 📅 2019-12-06。
> 如果你是一名Android、iOS、或前端开发人员，有者一颗积极进取的心，欢迎关注[《React Native Awesome》](https://github.com/crazycodeboy/react-native-awesome) ⭐ 1,817 | 🐛 8 | 📅 2019-12-06。本项目汇集了各类React Native学习资料、工具、组件、开源App、以及相关新闻等。
...
* [React Native 学习笔记](https://github.com/crazycodeboy/RNStudyNotes) ⭐ 4,059 | 🐛 13 | 🌐 Objective-C | 📅 2020-07-27
* [React Native 每日一学(Learn a little every day)](https://github.com/crazycodeboy/RNStudyNotes/tree/master/React%20Native%20%E6%AF%8F%E6%97%A5%E4%B8%80%E5%AD%A6) ⭐ 4,059 | 🐛 13 | 🌐 Objective-C | 📅 2020-07-27
...
* [React Native官方Demo](https://github.com/facebook/react-native/tree/master/Examples) ⭐ 126,339 | 🐛 1,050 | 🌐 C++ | 📅 2026-08-13：React Native官方Demo，汇集了各种组件，API的使用Examples。

* [Facebook F8 App ](https://github.com/fbsamples/f8app) ⚠️ Archived：基于React Native 的2016 F8大会APP。

* [react-native-nw-react-calculator](https://github.com/benoitvallon/react-native-nw-react-calculator) ⭐ 5,210 | 🐛 25 | 🌐 JavaScript | 📅 2021-10-03：基于React Native的计算器，iOS/Android、Web、桌面多端。

* [HackerNews-React-Native](https://github.com/iSimar/HackerNews-React-Native) ⭐ 3,712 | 🐛 12 | 🌐 JavaScript | 📅 2022-03-17：Hacker 新闻客户端。

* [ZhiHuDaily-React-Native](https://github.com/race604/ZhiHuDaily-React-Native) ⭐ 3,654 | 🐛 32 | 🌐 JavaScript | 📅 2023-09-19：知乎日报Android版。

* [reading](https://github.com/attentiveness/reading) ⭐ 3,410 | 🐛 15 | 🌐 JavaScript | 📅 2022-12-06：iReading App。

* [GitHubPopular](https://github.com/crazycodeboy/GitHubPopular) ⭐ 2,949 | 🐛 67 | 🌐 JavaScript | 📅 2019-08-08：基于React Native的查看、阅读、收藏GitHub上 最受欢迎的开源项目的APP，不仅如此，它还是一款GitHub Trending的客户端。

* [react-native-nba-app](https://github.com/wwayne/react-native-nba-app) ⭐ 2,213 | 🐛 8 | 🌐 Objective-C | 📅 2019-10-20：This is why we play。

* [FinanceReactNative](https://github.com/7kfpun/FinanceReactNative) ⭐ 2,075 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-06：Finance - 股票报价app。

* [react-native-dribbble-app](https://github.com/catalinmiron/react-native-dribbble-app) ⭐ 2,061 | 🐛 20 | 🌐 JavaScript | 📅 2023-10-13：基于React Native的Dribbble客户端。

* [noder-react-native](https://github.com/soliury/noder-react-native) ⚠️ Archived：Noder-cnodejs客户端。

* [react-native-gitfeed](https://github.com/xiekw2010/react-native-gitfeed) ⭐ 1,704 | 🐛 8 | 🌐 JavaScript | 📅 2017-04-13：一款基于React Native的GitHub客户端。

* [React-Native-Gank](https://github.com/Bob1993/React-Native-Gank) ⭐ 680 | 🐛 10 | 🌐 JavaScript | 📅 2016-07-31：Gank.io客户端。

* [leanote-ios-rnLeanote](https://github.com/leanote/leanote-ios-rn) ⭐ 222 | 🐛 2 | 🌐 JavaScript | 📅 2016-11-27：Leanote for iOS(云笔记)。

* [shopping-react-native](https://github.com/bigsui/shopping-react-native) ⭐ 15 | 🐛 13 | 🌐 JavaScript | 📅 2016-06-07 ：购物app-界面。
...
* [react-native-vector-icons ★2281](https://github.com/oblador/react-native-vector-icons) ⭐ 17,905 | 🐛 15 | 🌐 TypeScript | 📅 2026-05-26：用于 React Native的可定制的图标资源库，支持 NavBar/TabBar, image source 以及样式。

### Navigation

* [react-native-router-flux](https://github.com/aksonov/react-native-router-flux) ⭐ 8,916 | 🐛 334 | 🌐 JavaScript | 📅 2023-06-28：一款很火的导航组件。
* [react-native-drawer](https://github.com/root-two/react-native-drawer) ⭐ 2,527 | 🐛 184 | 🌐 JavaScript | 📅 2022-04-09：另一款抽屉组件。
* [react-native-tab-navigator](https://github.com/exponentjs/react-native-tab-navigator) ⭐ 2,384 | 🐛 19 | 🌐 JavaScript | 📅 2020-09-30：一款兼容Android、iOS的TabBar组件。
...
* [react-native-swiper](https://github.com/leecade/react-native-swiper) ⭐ 10,488 | 🐛 780 | 🌐 JavaScript | 📅 2026-02-01：一款轮番滑动的组件。
...
* [react-native-sortable-listview](https://github.com/deanmcpherson/react-native-sortable-listview) ⭐ 911 | 🐛 72 | 🌐 JavaScript | 📅 2022-07-07：拖拽排序组件。
...
* [react-native-htmlview](https://github.com/jsdf/react-native-htmlview) ⭐ 2,754 | 🐛 144 | 🌐 JavaScript | 📅 2024-06-11：HTML显示组件，渲染HTML text 。

### 弹框

* [react-native-easy-toast](https://github.com/crazycodeboy/react-native-easy-toast) ⭐ 1,146 | 🐛 84 | 🌐 JavaScript | 📅 2024-04-25：一款用于React Native上消息提示弹框组件，使用方便，支持定义Toast，支持iOS,Android。
...
* [mrn](https://github.com/binggg/mrn) ⭐ 1,720 | 🐛 14 | 🌐 JavaScript | 📅 2019-05-28：Material Design组件库。
...
* [RNShareSDK](https://github.com/kengsir/RNShareSDK) ⭐ 92 | 🐛 4 | 🌐 Objective-C | 📅 2016-12-06：一款基于原生平台ShareSDK的ReactNative插件,方便RN开发者集成各大社交平台的分享和授权功能。
* [react-native-launch-image](https://github.com/reactnativecn/react-native-launch-image) ⭐ 51 | 🐛 5 | 🌐 Objective-C | 📅 2017-10-19：用在React Native上手动关闭iOS启动界面（Launch Screen）的工具。[详细说明](http://reactnative.cn/post/2199)
...
* [Redux](https://github.com/reactjs/redux/) ⭐ 61,517 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02：用于JavaScript apps上的一款可预见的状态管理框架。
* [redux-react-native-i18n](https://github.com/derzunov/redux-react-native-i18n) ⭐ 47 | 🐛 0 | 🌐 JavaScript | 📅 2018-05-29 An i18n solution with plural forms support for React Native apps on Redux
...
* [react-native-web](https://github.com/necolas/react-native-web) ⭐ 22,139 | 🐛 159 | 🌐 JavaScript | 📅 2025-10-16：使用React Native组建Web应用。
